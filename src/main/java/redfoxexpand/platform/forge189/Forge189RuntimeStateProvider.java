...
/** Forge 1.8.9-only adapter from live client state to the pure Schema v3 snapshot. */
public final class Forge189RuntimeStateProvider {
    private Forge189RuntimeStateProvider() { }
